...
public class AddressBook {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Welcome to the Addressbook, Manage your contacts " + "with the Address book");
...
/*
 * Ability to ensure there is no Duplicate Entry of the same Person in a particular Address Book - Duplicate Check is
 */
